...
- (void)setupImageURLString:(NSString *)imageURLString mineLoadImage:(BOOL)mineLoadImage{
    [UIImage loadWithBlock2x:@"recommend_banner" Image:^(UIImage * _Nonnull imageBlock) {
        [self setupImageURLString:imageURLString placeholderImage:imageBlock mineLoadImage:mineLoadImage];
    }];
}
...
- (void)setupImageURLString:(NSString *)imageURLString
    ...
    [self.bannerImageView sd_setImageWithURL:imageURL placeholderImage:placeholderImage];
...
//    #endif
    ...
    NSURL * imageURL = [NSURL URLWithString:self.imageURLString];
    [self.bannerImageView sd_setImageWithURL:imageURL];
...
- (UILabel *)lableTitle {
    if (!_lableTitle) {
        ...
        _lableTitle.font = PingFangFont_Medium(15);
        _lableTitle.textColor = kWhiteColor;
        _lableTitle.numberOfLines = 2;
...
- (UIView *)bottomView {
    if (!_bottomView) {
        ...
        [self.bannerImageView addSubview:_bottomView];
        [_bottomView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.right.bottom.mas_equalTo(0);
            make.height.mas_equalTo(55);
        }];
        [_bottomView gradientViewFrame:CGRectMake(0, 0, kScreenWidth - 40, 55) Horizontal:NO firstColor:[UIColor colorWithHexString:@"#000000" alpha:0.000001] lastColor:[UIColor colorWithHexString:@"#000000" alpha:1.0] CornerRadius:0];
    }
    return _bottomView;
}
